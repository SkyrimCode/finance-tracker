...
const AddCard = () => {
  ...
  // List of banks and their logo filenames (webp/webp/png as per your assets)
  const banks = [
  ...
  const handleSubmit = (e) => {
    ...
    const cardRef = push(ref(db, `users/${email}/cards`));
    set(cardRef, { ...form, createdAt: new Date().toISOString() })
      .then(() => {
        navigate("/cards");
      })
      .catch((error) => {
  ...
  return (
    <div className="flex w-full">
      <form
        className="p-4 w-full md:ml-16 md:mr-0 md:mx-0"
        style={{
